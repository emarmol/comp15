...
int main() {
	...
	//for (int i=0;i<NUM_STUDENTS-1;i++) {
		comp15.drop_student(students[0]);
comp15.drop_student(students[1]);
comp15.drop_student(students[2]);
comp15.drop_student(students[3]);
comp15.drop_student(students[4]);
comp15.drop_student(students[5]);
comp15.drop_student(students[6]);
comp15.drop_student(students[7]);
comp15.drop_student(students[8]);
comp15.drop_student(students[9]);
		//}


	std::cout << "WAITLISTPOSTIIONS \n" <<
	    comp15.waitlist_position(comp15.status(students[10]), students[10]) 
	<< endl;
...
/*	cout << "\nIncreasing capacity to 7.\n";
	...
	comp15.drop_student(Student("Violet,Chester",false));
	comp15.drop_student(Student("Fuchsia,Rebecca",false));
	print_all_status(comp15);
	print_all_students(students, &comp15);
	cout << "\nDone!\n";
*/
